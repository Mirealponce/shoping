...
{
    public class GenericRepository<Tbl_Entity> : MyRepository<Tbl_Entity> where Tbl_Entity : class
    {
        DbSet<Tbl_Entity> _dbSet;
        private VentasEntities1 _DBEntity;
        public GenericRepository(VentasEntities1 DBEntity)
        {
            _DBEntity = DBEntity;
